...
{
    public partial class Measures1 : Form
    {
        ...
        private void Measures1_Load(object sender, EventArgs e)
        {
            try
            {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة المبرمج ، شكرا" + ee.Message, "ERROR 1001 Measures1", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة المبرمج ، شكرا" + ee.Message, "ERROR 1002 Measures1", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void text_price_Other_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة المبرمج ، شكرا" + ee.Message, "ERROR 1003 Measures1", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void text_price_Other_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة المبرمج ، شكرا" + ee.Message, "ERROR 1004 Measures1", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void t1_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة المبرمج ، شكرا" + ee.Message, "ERROR 1005 Measures1", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void t2_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة المبرمج ، شكرا" + ee.Message, "ERROR 1006 Measures1", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void t3_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة المبرمج ، شكرا" + ee.Message, "ERROR 1007 Measures1", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void t4_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة المبرمج ، شكرا" + ee.Message, "ERROR 1008 Measures1", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void groupBox5_Enter(object sender, EventArgs e)
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة المبرمج ، شكرا" + ee.Message, "ERROR 1009 Measures1", MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة المبرمج ، شكرا" + ee.Message, "ERROR 1014 Measures1", MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة المبرمج ، شكرا" + ee.Message, "ERROR 1015 Measures1", MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة المبرمج ، شكرا" + ee.Message, "ERROR 1016 Measures1", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void text_Name_Measures1_Leave(object sender, EventArgs e)
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة المبرمج ، شكرا" + ee.Message, "ERROR 1010 Measures1", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void text_Name_Measures2_Leave(object sender, EventArgs e)
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة المبرمج ، شكرا" + ee.Message, "ERROR 1011 Measures1", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void text_Name_Measures3_Leave(object sender, EventArgs e)
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة المبرمج ، شكرا" + ee.Message, "ERROR 1012 Measures1", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void text_Name_Measures4_Leave(object sender, EventArgs e)
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة المبرمج ، شكرا" + ee.Message, "ERROR 1013 Measures1", MessageBoxButtons.OK, MessageBoxIcon.Error);
